...
from train.torch.nlp.network.textnas.ops import ConvBN, LinearCombine, AvgPool, MaxPool, RNN, Attention, BatchNorm
from train.torch.nlp.network.textnas.utils import GlobalMaxPool, GlobalAvgPool
